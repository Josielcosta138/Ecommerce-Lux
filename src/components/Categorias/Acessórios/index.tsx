...
const Acessorios: FC = () => {
  ...
  const carregarProdutos = async () => {
    const response = await apiGet(`produtos/carregar/todascategoria/${4}`);
  ...
  return (
    <>
        <div className="titulo-descricao">
            <h2 className="titulo-categoria">Conjuntos</h2>
            <p className="descricao-categoria">
              Confira nossa seleção exclusiva de conjuntos de diversas categorias e
              estilos. <PiPants style={{ fontSize: '24px', marginLeft: '8px', marginBottom: '-5px' }}/> +<LiaTshirtSolid style={{ fontSize: '24px', marginLeft: '8px', marginBottom: '-5px' }}/>
            </p>
        </div>
