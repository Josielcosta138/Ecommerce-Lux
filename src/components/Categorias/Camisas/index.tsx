...
const Calca: FC = () => {
  ...
  const carregarProdutos = async () => {
    const response = await apiGet(`produtos/carregar/todascategoria/${2}`);
  ...
  return (
    <>
        <div className="titulo-descricao">
            <h2 className="titulo-categoria">Camisetas</h2>
            <p className="descricao-categoria">
              Confira nossa seleção exclusiva de camisas de diversas categorias e
              estilos. <LiaTshirtSolid style={{ fontSize: '24px', marginLeft: '8px', marginBottom: '-5px' }}/>
            </p>
        </div>
